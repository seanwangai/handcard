...
prompt = """
把圖片中的信息，分類進入以下欄位: 产品卖点 市场价格 直播价格 产品信息 口味 贈品 其他优势，並以json 格式輸出

======== 格式注意事項：
json 維持一層就好 key: string value，確保都是 "key": "value"
非常重要 不能出現 多個 string item， 下面這樣是不行的
"市场价格": {
    "无刺绣|小号(无拉链):39.9",
    "无刺绣|大号(拉链款):59.9",
}
...
＝＝＝＝＝ 欄位注意事項：
 产品卖点：
 要學習範例內的，要有【】，產品亮點 要越詳細越好，越長越完整越好 越長越好 圖片內的文字有提到的 全部都要納入
 還要有以下
...
以下是 範例 
{
"产品卖点": "大家是不是觉得最近夏日炎炎，特别想吹空调，喝冷饮，吃东西偶尔觉得不是特别有胃口但深夜总想吃点重口味的呢，你知道为什么吗？因为三伏天来了，三伏天，正是我们进行数字管理的黄金时期，在这个阶段内，你的努力很有可能事半功倍，但是如果错过了，就要再等一年。今天的这款薏米水和桂圆水特别适合正在数字管理的宝贝们，大家一定要抓住入伏40天
【试用人群】
1. 早上起来脸泡、手泡、脚泡的，感觉怎么自己的脸照镜子和昨晚都不太一样的，一定要早上来一杯黑咖啡的  2. 别人醒来一秒钟脉动进入工作状态的，而你浑身懒洋洋的，容易累、容易乏的  3. 最近爱吹空调、吃冷饮、喝冰水冰咖啡并且还管不住嘴，爱吃油的辣的 4. 大便挂壁的，背上脸上点点的
【配料表】0糖0脂0卡路里0添加0碳水，微沸慢熬，早上的第一杯放心水，冷热皆宜随时随地打开就可以直接喝，平时常温储存
【五指毛桃薏米水】就是被称为"广东人参"的五指毛桃+晾晒10天以上的薏米，选用炒过的薏米，因为这样不仅更给力，而且更好喝，每瓶添加超过750mg的五指毛桃，以及5000mg薏米
